  ...
  const handleSave = async () => {
    ...
    try {
      await api.put('/admin/settings/security', {
        ...
        uploadLimits: {
          ...form.uploadLimits,
          allowedImageMimes:  toArr(imgMimes),
          allowedMediaMimes:  toArr(mediaMimes),
        },
        botBlocking: {
          ...form.botBlocking,
          ipWhitelist: toArr(whitelist),
          ipBlacklist: toArr(blacklist),
        },
      });
      setSuccess(true);
                ...
                {[
                  ...
                  <div key={key}>
                    ...
                    <input
                      ...
                      className={INPUT}
                      value={form.recaptcha.thresholds[key]}
                      onChange={e => setRCT(key, Number(e.target.value))}
                    />
                  </div>
                ))}
              </div>
