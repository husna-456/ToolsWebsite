...
const SECTIONS = [
  {
    ...
    body: [
      'Global Tech Tools is designed to be used without creating an account. We collect minimal information to provide our services.',
  ...
  },
  {
    ...
    body: [
      'Global Tech Tools is not directed at children under 13. We do not knowingly collect personal information from children under 13. If you believe we have inadvertently collected such information, please contact us immediately.',
    ],
  },
  {
    title: 'Changes to This Policy',
    body: [
      'We may update this Privacy Policy from time to time. When we do, we will update the "Last updated" date at the top of this page. Continued use of Global Tech Tools after any changes constitutes your acceptance of the updated policy.',
    ],
  },
  {
    title: 'Contact Us',
...
export default function PrivacyPage() {
  return (
    <>
      <SEOHead
        customTitle="Privacy Policy — Global Tech Tools"
        customDesc="Learn how Global Tech Tools collects, uses, and protects your information."
      />
      ...
      <section className="max-w-3xl mx-auto px-5 sm:px-8 py-14">
        ...
        >
          ...
          <p className="text-[#475569] text-sm leading-relaxed">
            Global Tech Tools is built on a simple principle: <strong className="text-[#0F172A]">use our tools without giving up your privacy.</strong>{' '}
